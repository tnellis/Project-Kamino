...
// Function to submit PartList info to database.
	function submitinvForm() {
		...
		// Form push - Submits with key > set values : input values.
		$(document).read(function(){
			var cbmodelinv 	= $('#cbmodelinvInput').val();
			var cbpartinv 	= $('#cbpartinvInput').val();
			var quaninv 	= $('#quaninvInput').val();
			partRef.push({cbmodelinv: cbmodelinv, cbpartinv: cbpartinv, quaninv: quaninv });
		})
	}
